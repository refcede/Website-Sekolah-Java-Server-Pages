<%-- File: WebContent/indexJurusan.jsp --%>
...
<body>
    ...
    <div class="container">
        ...
        <div class="content-card">
            ...
            <a href="JurusanServlet?action=new" class="btn btn-primary mb-4">
                Tambah Jurusan Baru
            </a>
    <a href="KurikulumServlet" class="btn btn-outline-success mb-4 ms-2">
        Kelola Kurikulum Mapel
    </a>
            <table class="table table-hover align-middle">
                <thead>
                    <tr>
                        <th style="width: 10%;">ID Jurusan</th>
                        <th>Nama Jurusan</th>
                ...
                <tbody>
                    <c:forEach var="jur" items="${listJurusan}">
                        <tr>
                            <td><c:out value="${jur.idJurusan}" /></td>
                            <td><c:out value="${jur.namaJurusan}" /></td>
                            <td class="text-end">
                                <a href="JurusanServlet?action=edit&id=<c:out value='${jur.idJurusan}'/>" 
                                   class="btn btn-sm btn-outline-primary">Edit</a>
                                   
                                <a href="JurusanServlet?action=delete&id=<c:out value='${jur.idJurusan}'/>" 
                                   class="btn btn-sm btn-outline-danger ms-2" 
                                   onclick="return confirm('Yakin ingin menghapus jurusan ini? Siswa yang ada di jurusan ini akan diatur ke NULL.')">Hapus</a>
                            </td>
                        </tr>
                    </c:forEach>
